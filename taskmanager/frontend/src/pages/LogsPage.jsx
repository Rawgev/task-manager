  ...
  return (
    <div className="w-full max-w-4xl p-4 sm:p-6 lg:p-8">
      <div className="mb-6 sm:mb-8">
        <h2 className="text-2xl sm:text-3xl font-bold font-display">Activity Logs</h2>
      ...
      {loading ? (
        ...
        <div className="card p-8 sm:p-12 text-center text-slate-400">No activity yet.</div>
      ) : (
        <div className="card divide-y divide-slate-100 dark:divide-slate-800">
          {logs.map((log) => (
            <div key={log._id} className="flex items-start gap-3 px-4 py-4 sm:gap-4 sm:px-6">
